// Content for the PEFA Branch Kiwanja Cathedral (PBKC) website.
...
export const pastor = {
  ...
  photo: "/bishop.jpg",
  photoAlt: "Bishop Peter Muchai with his wife",
  ...
  social: {
    facebook: "https://www.facebook.com/PBKCtv",
    facebook_bishop: "https://www.facebook.com/peter.muchai.79656",
    instagram: "#",
    youtube: "https://www.youtube.com/@PEFA_KIWANJA_TV",
  },
};
...
// The cathedral's 2026 calendar — events that have happened this year, mined
// from the church's Facebook posts (via findglocal) and PEFA Kiwanja TV
// broadcasts. Past events use capacity 0 (attendance figures aren't published);
// upcoming programmes carry a capacity so RSVP is meaningful.
const CATHEDRAL_VENUE = "PEFA Branch Kiwanja Cathedral, Kahawa West";

export const events: ChurchEvent[] = [
  // ── This year's services & gatherings (chronological) ──
  {
    slug: "sunday-service-gods-continued-blessing",
    title: "Sunday Service: God's Continued Blessing",
    description:
      "A Sunday service ministered by Elder Mary Migwi — an encouragement to walk with and follow the Lord, who continues to bless His people.",
    venue: CATHEDRAL_VENUE,
    date: "2026-05-03",
    time: "9:00 AM",
  ...
  {
    slug: "mothers-celebration-sunday-service",
    title: "Mother's Celebration Sunday Service",
    description:
      "A special Sunday service honouring and celebrating the mothers of the cathedral, led by Elder Miriam Mwaura.",
    venue: CATHEDRAL_VENUE,
    date: "2026-05-10",
    time: "9:00 AM",
  ...
  {
    slug: "first-service-mercy",
    title: "First Service: Mercy",
    description: "Welcome to our first service — a message on the mercy of God, preached by Rev. Victor Baraza.",
    venue: CATHEDRAL_VENUE,
    date: "2026-05-17",
    time: "9:00 AM",
    organizer: "PEFA Kiwanja Cathedral",
  ...
  {
    slug: "midweek-total-surrender",
    title: "Midweek Service: Total Surrender",
    description:
      "A midweek encouragement — even when we feel dejected, there is hope and healing in God's presence when we come to Him in total surrender.",
    venue: CATHEDRAL_VENUE,
    date: "2026-05-22",
    time: "6:00 PM",
    organizer: "PEFA Kiwanja Cathedral",
  ...
  {
    slug: "worship-experience-divine-restoration",
    title: "The Worship Experience: Divine Restoration",
    description:
      "A Sunday Worship Experience under the theme 'Divine Restoration' — praise, prayer, and the ministry of the Word, from 9:00 AM to 1:00 PM.",
    venue: CATHEDRAL_VENUE,
    date: "2026-05-24",
    time: "9:00 AM",
  ...
  {
    slug: "sunday-service-endurance",
    title: "Sunday Service: Endurance",
    description: "A call to persevere and remain steadfast in faith through every season, preached by Rev. Victor Baraza.",
    venue: CATHEDRAL_VENUE,
    date: "2026-05-31",
    time: "9:00 AM",
    organizer: "PEFA Kiwanja Cathedral",
  ...
  {
    slug: "sunday-service-the-lord-breaks-his-silence",
    title: "Sunday Service: The Lord Breaks His Silence",
    description: "A Sunday message on hearing God speak after seasons of waiting.",
    venue: CATHEDRAL_VENUE,
    date: "2026-06-07",
    time: "9:00 AM",
  ...
  {
    slug: "bible-study-doctrine-of-salvation",
    title: "Bible Study: The Doctrine of Salvation",
    description: "A Bible study on the doctrine of salvation and assurance in Christ, taught by Deacon Samuel Karisa Gohu.",
    venue: CATHEDRAL_VENUE,
    date: "2026-06-07",
    time: "6:00 PM",
  ...
  {
    slug: "ladies-sunday-service-from-suffering-to-glory",
    title: "Ladies' Sunday Service: From Suffering to Glory",
    description:
      "A Ladies' Sunday Service on the hope of glory that outweighs present suffering, presented by Lucy Benard.",
    venue: CATHEDRAL_VENUE,
    date: "2026-06-14",
    time: "9:00 AM",
    organizer: "Women's Ministry",
  ...
  {
    slug: "bible-study-the-study-of-salvation",
    title: "Bible Study: The Study of Salvation",
    description: "Continuing the study of salvation and what it means to be saved, taught by Deacon Samuel Karisa Gohu.",
    venue: CATHEDRAL_VENUE,
    date: "2026-06-14",
    time: "6:00 PM",
    organizer: "Bible Study Ministry",
  ...
  {
    slug: "grace-for-prosperity-part-1-service",
    title: "Sunday Service: Grace for Prosperity (Part 1)",
    description: "Part one of the Grace for Prosperity in Challenging Times series, preached by Rev. Victor Baraza.",
    venue: CATHEDRAL_VENUE,
    date: "2026-06-28",
    time: "9:00 AM",
    organizer: "PEFA Kiwanja Cathedral",
  ...
  {
    slug: "grace-for-prosperity-part-2-service",
    title: "Sunday Service: Grace for Prosperity (Part 2)",
    description: "Part two of the Grace for Prosperity in Challenging Times series, preached by Rev. Victor Baraza.",
    venue: CATHEDRAL_VENUE,
    date: "2026-07-05",
    time: "9:00 AM",
    organizer: "PEFA Kiwanja Cathedral",
  ...
  {
    slug: "bible-study-practical-christian-living-lesson-1",
    title: "Bible Study: Practical Christian Living, Lesson 1",
    description: "The opening lesson of the Practical Christian Living series, taught by Elder Mrs. Njuguna.",
    venue: CATHEDRAL_VENUE,
    date: "2026-07-09",
    time: "6:00 PM",
    organizer: "Bible Study Ministry",
  ...
  {
    slug: "grace-for-prosperity-part-3-service",
    title: "Sunday Service: Grace for Prosperity (Part 3)",
    description: "Part three of the Grace for Prosperity in Challenging Times series, preached by Rev. Victor Baraza.",
    venue: CATHEDRAL_VENUE,
    date: "2026-07-12",
    time: "9:00 AM",
    organizer: "PEFA Kiwanja Cathedral",
  ...
  {
    slug: "bible-study-practical-christian-living-lesson-2",
    title: "Bible Study: Practical Christian Living, Lesson 2",
    description: "Lesson two of the Practical Christian Living series, taught by Elder Mrs. Njuguna.",
    venue: CATHEDRAL_VENUE,
    date: "2026-07-16",
    time: "6:00 PM",
    organizer: "Bible Study Ministry",
  ...
  {
    slug: "sunday-service-the-winning-weak",
    title: "Sunday Service: The Winning Weak",
    description: "A message on how God's strength is made perfect in our weakness, ministered by Bishop Peter Muchai.",
    venue: CATHEDRAL_VENUE,
    date: "2026-07-19",
    time: "9:00 AM",
    organizer: "PEFA Kiwanja Cathedral",
  ...
  {
    slug: "bible-study-practical-christian-living-lesson-3",
    title: "Bible Study: Practical Christian Living, Lesson 3",
    description: "Lesson three of the Practical Christian Living series, taught by Elder Mrs. Njuguna.",
    venue: CATHEDRAL_VENUE,
    date: "2026-07-23",
    time: "6:00 PM",
    organizer: "Bible Study Ministry",
  ...
  {
    slug: "sunday-worship-service-july-26",
    title: "Sunday Worship Service",
    description: "The full Sunday worship experience — praise, prayer, and the preaching of the Word, broadcast live on PEFA Kiwanja TV.",
    venue: CATHEDRAL_VENUE,
    date: "2026-07-26",
    time: "9:00 AM",
    organizer: "PEFA Kiwanja Cathedral",
  ...
  {
    slug: "bible-study-work-and-integrity",
    title: "Bible Study: Work and Integrity (Practical Christian Living, Lesson 4)",
    description:
      "Lesson four of the Practical Christian Living series — how work and integrity shape a faithful, modern Christian life, taught by Elder Mrs. Njuguna.",
    venue: CATHEDRAL_VENUE,
    date: "2026-07-30",
    time: "6:00 PM",
    organizer: "Bible Study Ministry",
  ...
  {
    slug: "grace-for-prosperity-choir-celebration",
    title: "Choir & Worship Celebration",
    description: "The Oasis of Hope cathedral choir leads the congregation in praise during the Grace for Prosperity series.",
    venue: CATHEDRAL_VENUE,
    date: "2026-06-28",
    time: "9:00 AM",
    organizer: "Worship Team",
  ...
  // ── Upcoming ──
  {
    slug: "sunday-worship-experience-upcoming",
    title: "Sunday Worship Experience",
    description:
      "Our weekly live worship experience — praise, prayer, and the preaching of the Word. Join us in person or on PEFA Kiwanja TV.",
    venue: CATHEDRAL_VENUE,
    date: "2026-08-02",
    time: "9:00 AM",
    organizer: "PEFA Kiwanja Cathedral",
  ...
  {
    slug: "midweek-bible-study-upcoming",
    title: "Midweek Bible Study",
    description: "Continue the Practical Christian Living series and grow together in the Word.",
    venue: CATHEDRAL_VENUE,
    date: "2026-08-05",
    time: "6:00 PM",
    organizer: "Bible Study Ministry",
