...
export const churchInfo = {
  ...
  serviceTimes: "Sundays, 9:15 AM – 1:15 PM",
...
export const aboutContent = {
  ...
  serviceSchedule: [
    { day: "Sunday", time: "7:00 AM", label: "Morning Devotions" },
    { day: "Sunday", time: "8:00 AM", label: "Bible Study" },
    { day: "Sunday", time: "9:15 AM", label: "First Service" },
    { day: "Sunday", time: "11:15 AM", label: "Second Service" },
    { day: "Thursday", time: "6:00 PM", label: "Midweek Service" },
    { day: "Saturday", time: "6:00 PM", label: "Praise & Worship Practice" },
  ],
};
